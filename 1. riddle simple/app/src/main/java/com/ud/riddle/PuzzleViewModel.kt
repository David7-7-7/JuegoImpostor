...
class PuzzleViewModel : ViewModel() {
    ...
    var seleccion = mutableStateOf<Int?>(null) // Tenemos un entero que puede ser nulo o no
    ...
    fun inicializar(){
        ...
        numeros.addAll(solucion)// Les agregamos todos los numeros de la lista
        numeros.shuffle() // Revolvemos los numeros
